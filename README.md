...
- `ggMcCabeSim_help.html` — usage instructions and documentation

## Usage
Download `gMcCabeSim.part1.exe`, 'gMcCabeSim.part2.rar' and 'gMcCabeSim.part3.rar' from this repository or from the Releases page. Run gMcCabeSim.part1.exe and select a directory where you want to install the program. It will create the executable 'ggMcCabeSim.exe' which you can run.
